...
class CassandraService:
    ...
    def insert_prediction(self, image, image_name, predicted_disease):
        ...
        insert_prediction_stmt = self.session.prepare('INSERT INTO ' + Config.PREDICTIONS_TABLE +
                                                      ...
                                                      'predicted_disease) VALUES (?, ?, ?, ?, ?)')

        self.session.execute(insert_prediction_stmt, [prediction_timestamp, record_id, image, image_name, predicted_disease])